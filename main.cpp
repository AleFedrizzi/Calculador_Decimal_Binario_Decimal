...
int main()
{
    ...
    if(opcao == 1){
        cout << "\nDigite o número: ";
        cin >> numero;
        while(numero!=0){ // Laço onde occore a divisao do número por 2, enquanto esse número for diferente de 0"
    ...
    // Binário para decimal
        ...
        //Laço que separa o numero digitado em casas de um bit
        for(i=0; i<8; i++){
            digito[i]=binario%10;
            binario/=10;
        }
        /*laço que faz a multiplicação de cada digito com a potencia de 2 elevado a pot,
        sendo que pot está icializada em 7 e recebe um decremento a cada loop*/
        for(i=7; i>=0; i--){
